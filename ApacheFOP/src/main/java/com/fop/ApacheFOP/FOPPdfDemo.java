...
public class FOPPdfDemo {
	...
	public static void main(String a[]) {
     ...
     public void convertToPDF()  throws IOException, FOPException, TransformerException {
         // the XSL FO file
         File xsltFile = new File("src/main/java/template.xsl");
         // the XML file which provides the input
         StreamSource xmlSource = new StreamSource(new File("src/main/java/Employees.xml"));
         ...
         // Setup output
         OutputStream out;
         out = new java.io.FileOutputStream("src/main/java/employee.pdf");
     ...
     public void convertToFO()  throws IOException, FOPException, TransformerException {
         ...
         out = new java.io.FileOutputStream("src/main/java/main/java/temp.fo");
